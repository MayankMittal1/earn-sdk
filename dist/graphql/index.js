...
exports.stableswapClient = exports.masterChefV3Client = exports.masterChefV2Client = exports.pancakeswapClient = exports.voltageClient = exports.fuseswapClient = exports.uniswapClient = void 0;
...
exports.voltageClient = new core_1.ApolloClient({
    link: new core_1.HttpLink({ uri: constants_1.VOLTAGE_SUBGRAPH_URL, fetch: cross_fetch_1.default }),
    cache: new core_1.InMemoryCache()
});
...
exports.stableswapClient = new core_1.ApolloClient({
    link: new core_1.HttpLink({ uri: constants_1.STABLESWAP_SUBGRAPH_URL, fetch: cross_fetch_1.default }),
    cache: new core_1.InMemoryCache()
});
