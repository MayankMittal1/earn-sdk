...
exports.isStableswap = exports.getChefSubgraph = exports.getChef = exports.calculateApy = exports.calculateReserves = exports.numberToWei = exports.weiToNumber = void 0;
...
function calculateReserves(globalTotalStake, totalSupply, totalReserves) {
    const reserves = totalReserves.map((totalReserve) => new bignumber_js_1.BigNumber(globalTotalStake)
...
function isStableswap(address) {
    return !!constants_1.STABLESWAP_POOL_LP_HASH[address];
}
exports.isStableswap = isStableswap;
