...
export declare function calculateReserves(globalTotalStake: string, totalSupply: string, totalReserves: string[]): BigNumber[];
...
export declare function isStableswap(address: string): boolean;
